...
static int sr200pc20_get_iso_speed_rate(struct v4l2_subdev *sd)
{
	...
	sr200pc20_i2c_read_byte(client, 0xb0, (unsigned short*)&read_value);
...
static int sr200pc20_get_shutterspeed(struct v4l2_subdev *sd)
{
	...
	sr200pc20_i2c_write_byte(client, 0x03, 0x20);
	sr200pc20_i2c_read_byte(client, 0x80, (unsigned short*)&read_value);
	cintr = (int)read_value << 19;
	sr200pc20_i2c_read_byte(client, 0x81, (unsigned short*)&read_value);
	cintr += (int)read_value << 11;
	sr200pc20_i2c_read_byte(client, 0x82, (unsigned short*)&read_value);
...
#ifdef NEW_CAM_DRV
	/* .enum_mbus_fmt = sr200pc20_enum_fmt, */
