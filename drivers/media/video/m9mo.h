...
#define M9MO_LENS_AF_SCAN_RANGE		0x00
#define M9MO_LENS_AF_MODE			0x01
#define M9MO_LENS_AF_START			0x02
#define M9MO_LENS_AF_STATUS			0x03
#define M9MO_LENS_AF_MODE_SELECT	0x05
#define M9MO_LENS_AF_UPBYTE_STEP	0x06
#define M9MO_LENS_AF_LOWBYTE_STEP	0x07
...
#define M9MO_CAPPARM_LIGHT_CTRL		0x40
#define M9MO_CAPPARM_FLASH_CTRL		0x41
...
/* Interrupt Factor */
#define M9MO_INT_SOUND		(1 << 7)
#define M9MO_INT_LENS_INIT	(1 << 6)
#define M9MO_INT_FD		(1 << 5)
#define M9MO_INT_FRAME_SYNC	(1 << 4)
#define M9MO_INT_CAPTURE	(1 << 3)
#define M9MO_INT_ZOOM		(1 << 2)
#define M9MO_INT_AF		(1 << 1)
#define M9MO_INT_MODE		(1 << 0)
