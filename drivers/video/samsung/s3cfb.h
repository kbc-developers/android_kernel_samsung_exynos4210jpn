...
#if defined(FEATURE_BUSFREQ_LOCK)
extern void s3cfb_busfreq_lock(struct s3cfb_global *fbdev, unsigned int lock);
extern void s3cfb_cpufreq_lock(struct s3cfb_global *fbdev, unsigned int lock);
#endif
