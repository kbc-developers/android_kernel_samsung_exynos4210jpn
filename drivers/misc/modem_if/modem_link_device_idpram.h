...
#define INT_CMD_PDA_SLEEP           0x000D
#define INT_CMD_DPRAM_DOWN          0x000B
#define INT_CMD_PDA_WAKEUP          0x000C
#define INT_CMD_CP_WAKEUP_START     0x000E
...
#define DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS 0x4
...
struct idpram_link_pm_data {
	...
	unsigned gpio_link_host_wakeup;
	unsigned gpio_link_cp_dump_int;

	unsigned irq_link_host_wakeup;
	unsigned irq_link_cp_dump_int;
